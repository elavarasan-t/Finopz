...
from src.controller import get_subscription_cost

router = APIRouter(tags=["Azure/CostManagement/Cost"])
     
@router.post('/individualSubscriptionCost')
@limiter.limit("50/minute")
async def subscriptionCost(Credential: Credentials, Data: CostRequest, request: Request, response: Response):
