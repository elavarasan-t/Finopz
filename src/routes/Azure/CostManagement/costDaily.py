...
from src.controller import get_cost_daily

router = APIRouter(tags=["Azure/CostManagement/Cost"])

@router.post('/costDaily')
@limiter.limit("50/minute")
async def cost_daily(Credential: Credentials, Data: CostRequest, request: Request, response: Response):
